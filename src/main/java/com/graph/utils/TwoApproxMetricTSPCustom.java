 ...
 */
public class TwoApproxMetricTSPCustom<V, E> implements HamiltonianCycleAlgorithm<V, E>
{
    public TwoApproxMetricTSPCustom()
    {
    ...
    public GraphPath<V, E> getTour(Graph<V, E> graph , V vertexStart)
    {
        if (!graph.getType().isUndirected()) {
            throw new IllegalArgumentException("Graph must be undirected");
        }
